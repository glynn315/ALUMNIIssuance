...
include('../StudentSession.php');
    ...
    $query ="SELECT * FROM studentuseraccount WHERE studentStatus = 'ALUMNI' AND studentCount = '$login_session';";  
...
if (isset($_POST["print"])) {
    mysqli_query($conn, "UPDATE requestinformation SET requestStatus = 'RELEASED' WHERE requestStatus = 'APPROVED' AND  studentID='$login_session';");

        echo
            "
            <script>
            alert('THANK YOU');
            document.location.href = 'studentDashboard.php';
            </script>
            ";
}
?>
                        ...
                        <form method="POST">
                            <div class="navbar-header d-inline-flex">
                                ...
                                <ul class="nav d-inline-flex p-2">
                                    ...
                                    <li class="ml-4"><a href="studentDashboard.php" onclick="window.print();" name=""><button type="submit" name="print"><i class="bi bi-printer-fill"></i></button></a></li>
                                </ul>
                            </div>
