...
if (isset($_POST["subConcern"])) {
    mysqli_query($conn, "INSERT INTO studentconcerninformation VALUES('','$studentNumber','$date','$_POST[text1]');");
        header("location:studentConsultation.php");
}
?>
<!DOCTYPE html>
<html>
            ...
            <div id="content" style="width:100%;">
                ...
                <div class="container-fluid d-inline-flex">
                	<div class="container p-4 border mt-5 rounded">
                        <h3>Student Consultation Form</h3>
                        ...
                        <form method="POST">
                            <table width="100%" class="mt-3">
                                ...
                                <tr>
                                    ...
                                    <td class="pl-4"><h4><?php echo $row["year"] ?></h4></td>
                                </tr>
                                <tr>
                                    <td class="text-right" width="30%">
                                        <h4>Course :</h4>
                                ...
                                <tr>
                                    ...
                                    <td class="pl-4"><textarea class="form-control" name="text1" placeholder="REMARKS"></textarea></td>
                                </tr>
                            </table>
                            <div class="modal-footer mt-4">
                                <button type="submit" class="btn btn-primary" name="subConcern">SUBMIT REPORT</button>
                            </div>
                        </form>
                    </div>
                </div>
