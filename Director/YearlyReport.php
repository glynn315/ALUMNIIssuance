...
if (isset($_REQUEST["studentYear"])) 
{
    $studentYear = $_REQUEST["studentYear"];

    $conn1 = mysqli_query($conn, "SELECT studentFname,studentLname,programCode,studentCount,studentYear FROM studentuseraccount WHERE studentYear = '$studentYear' AND studentStatus = 'Alumni'");
    ...
    class PDF extends TCPDF
    {
        public function Header()
        {
            ...
            $this->Ln(30);
            $this->Cell(0, 0, 'STUDENT GRADUATES OF BATCH ' . $studentYear  , 0, 1, 'C');
...
// helvetica or times to reduce file size.
    ...
    $pdf->Ln(5);
    $sql = "SELECT  studentFname,studentLname,programCode,studentCount,studentYear FROM studentuseraccount WHERE studentYear = '$studentYear' AND studentStatus = 'Alumni'";
