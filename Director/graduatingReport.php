...
while ($row = mysqli_fetch_array($conn1)) {
    ...
    class PDF extends TCPDF
    {
        public function Header()
        {
            ...
            $this->Ln(30);
            $this->Cell(0, 0, 'Holy Child Central Colleges, Inc. Graduating Students Report' , 0, 1, 'C');
            $this->SetFont('times', 'B', 14);
            $this->Cell(0, 0, 'List of GRADUATING', 0, 1, 'C');
            $this->Ln(2);
...
// helvetica or times to reduce file size.
    ...
    $pdf->Ln(5);
    $sql = "SELECT  studentFname,studentLname,programCode,studentCount,studentYear,studentStatus FROM studentuseraccount WHERE studentStatus != 'Alumni' ORDER BY studentCount ASC";
